    ...
    <header class= "header">
        ...
        <nav class= "navbar">
           ...
           <ul>
            ...
            <li><a href= "#carawakaf"><b>Data Wakaf</b></a></li>
...
<div class="banner">
    <div class="text-berjalan">
        <marquee direction="right">Muhammad Ridwan - <span>Uang : Rp.2.000,000</span> Hamba Allah - <span>Barang : Emas</span>
        Siti Aisyah - <span>Uang : Rp.2.000,000</span></marquee>
    </div>
</div>
<br>
...
if(isset($_POST['proses'])){
    mysqli_query($koneksi,"insert into aas_project set
    nama = '$_POST[nama]',
    id = '$_POST[id]',
    paket = '$_POST[paket]',
